...
> 체 $\mathbf{F}$의 임의의 스칼라 $a$와 벡터공간 $\mathbb{V}$의 임의의 벡터 $x$에 대하여 다음 세 가지 성질이 성립한다.
> 
...
>
> **전제**
> - [[LA-0101 벡터공간 (Vector Space)|벡터공간]]의 조건 (1), (3), (8)
> - (*) : $0+0=0$
> 
> **전개**
> 1. 
> $$\begin{align*} 0x + 0x \stackrel{\text{(8)}}{=} (0+0)x \stackrel{\text{(*)}}{=} 0x \stackrel{\text{(3)}}{=} 0x + \mathbf{0} \end{align*}$$
> 2. [[LA-0102 벡터합의 소거법칙 (Cancellation Law for Vector Addition)|벡터합의 소거법칙]] 에 의하여 다음을 얻는다
> 
> **결론($\therefore$)**
